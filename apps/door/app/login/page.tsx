...
import { API, API_Alive } from 'fw-roedingen-shared/api'
...
export default function page(props: Props) {
  ...
  const [api_alive, setApi_alive] = React.useState(false);
  ...
  React.useEffect(() => {
    let url = new URLSearchParams(window.location.search);
    let client_id = url.get('client_id');
    if(client_id !== null &&  client_id !== 'Door'){
      setIsOAuth(true);
    }
  }, []);
