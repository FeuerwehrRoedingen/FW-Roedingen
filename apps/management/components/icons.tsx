...
const ChevronDownIcon = ({fill, size, width = 24, height = 24, ...props}: IProps) => {
  return (
    <svg
      fill="none"
...
const TagUserIcon = ({fill, size, width = 24, height = 24, ...props}: IProps) => {
  return (
    <svg
      fill="none"
      height={size || height}
...
const ServerIcon = ({fill, size, width = 24, height = 24, ...props}: IProps) => {
  return (
    <svg
      fill="none"
      height={size || height}
...
const FlashIcon = ({fill, size, width = 24, height = 24, ...props}: IProps) => {
  return (
    <svg
      fill="none"
      height={size || height}
...
const ActivityIcon = ({fill, size, width = 24, height = 24, ...props}: IProps) => {
  return (
    <svg
...
const ScaleIcon = ({fill, size, width = 24, height = 24, ...props}: IProps) => {
  return (
    <svg
      fill="none"
      height={size || height}
