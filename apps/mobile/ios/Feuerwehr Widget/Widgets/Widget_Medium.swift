...
struct ExtendedData: GenericInit {
  let nextMeet: Date
  let nextEvent: Date
...
struct Feuerwehr_Widget_Medium: Widget {
    ...
    var body: some WidgetConfiguration {
        IntentConfiguration(kind: kind, intent: ConfigurationIntent.self, provider: Provider<ExtendedData>()) { entry in
...
struct Feuerwehr_Widget_Medium_Previews: PreviewProvider {
    static var previews: some View {
      EntryView(entry: Entry(date: Date(), configuration: ConfigurationIntent(), data: ExtendedData()))
